        ...
        md:px-[24px] px-[16px] lg:pt-[48px] lg:pb-[64px]">
                    <div>
                        ...
                        lg:text-[18px] lg:leading-[27px] md:text-[18px] md:leading-[27px]">
                            At <span className="text-[#111] font-medium">MysTEAry</span>, we value your trust and are committed to protecting your privacy. This Privacy Policy explains how we collect, use, and safeguard your information when you visit or make a purchase from our website.
                        </p>
                    </div>
                </div>
        ...
        md:px-[24px] px-[16px] lg:pb-[80px] xl:pb-[80px] 2xl:pb-[80px]">
                    ...
                    <ul className="list-disc pl-[20px] md:pl-[24px] lg:pl-[24px]">
                        ...
                        mb-[4px] lg:mb-[6px] md:mb-[6px]">
                            <span className="text-[#111] font-medium">Personal Information:</span> Name, email address, phone number, billing and shipping address.
                        </li>
                        <li className="text-[#444] text-[12px] leading-[18px]
                        lg:text-[16px] lg:leading-[24px] md:text-[16px] md:leading-[24px]
                         mb-[4px] lg:mb-[6px] md:mb-[6px]">
                            <span className="text-[#111] font-medium">Payment Details:</span> Securely processed through trusted third-party payment gateways (e.g. Stripe). We do not store your card or banking details.
                        </li>
                        <li className="text-[#444] text-[12px] leading-[18px]
                        lg:text-[16px] lg:leading-[24px] md:text-[16px] md:leading-[24px]">
                            <span className="text-[#111] font-medium">Usage Data:</span> Information about how you interact with our website, including IP address, browser type, device details, and browsing patterns.
                        </li>
                    </ul>
                    ...
                    <p className="text-[#444] text-[12px] leading-[18px]
                        lg:text-[16px] lg:leading-[24px] md:text-[16px] md:leading-[24px]
                         mb-[6px] lg:mb-[8px] md:mb-[8px]">
                            We do <span className="#111 font-medium">not sell</span> your personal information. Data may be shared only with:
                    </p>
                  <ul className="list-disc pl-[20px] md:pl-[24px] lg:pl-[24px]">
                        <li className="text-[#444] text-[12px] leading-[18px]
                        lg:text-[16px] lg:leading-[24px] md:text-[16px] md:leading-[24px]
