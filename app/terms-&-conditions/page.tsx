        ...
        md:px-[24px] px-[16px] lg:pt-[48px] lg:pb-[64px]">
                    <div>
                        ...
                        lg:text-[18px] lg:leading-[27px] md:text-[18px] md:leading-[27px]">
                            Welcome to <span className="text-[#111] font-medium">MysTEAry!</span> By accessing or using our website, you agree to the following terms and conditions. Please read them carefully before making a purchase.
                        </p>
                    </div>
                </div>
                    ...
                    <p className="text-[#444] text-[12px] leading-[18px]
                        lg:text-[16px] lg:leading-[24px] md:text-[16px] md:leading-[24px]
                         mb-[4px] lg:mb-[6px] md:mb-[6px]">
                            As stated in our <span className="text-[#111] font-medium">Shipping & Returns Policy,</span> no returns or refunds are allowed. Exchanges are possible only in case of damaged or incorrect products.
                    </p>
